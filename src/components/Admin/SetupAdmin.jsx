    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Setup Admin & Demo Users</h1>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-sm text-yellow-800 mt-2 space-y-1">
                ...
                <li>• Sau khi tạo xong, bạn có thể đăng nhập bằng các tài khoản này</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4 mb-6">
          <h3 className="font-semibold text-blue-900 mb-3">👥 Users sẽ được tạo:</h3>
          <div className="space-y-3">
            {users.map(user => (
              <div key={user.email} className="bg-white rounded-lg p-3 border border-blue-200">
        ...
        {results && (
          <div className="space-y-3">
            ...
            {results.every(r => r.success || r.error?.includes('đã tồn tại')) && (
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-4">
                <p className="text-sm text-blue-800">
                  🎉 <strong>Hoàn thành!</strong> Bạn có thể:
                  <br />
                  <span className="block mt-2">
                    1. <a href="/" className="text-blue-600 hover:underline font-semibold">Quay về trang đăng nhập</a>
                    <br />
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <h4 className="font-semibold text-gray-900 mb-3 text-sm">💡 Sau khi tạo xong:</h4>
          <ol className="text-xs text-gray-600 space-y-2 list-decimal list-inside">
            <li>Quay về trang chủ: <code className="bg-gray-100 px-2 py-0.5 rounded">http://localhost:3000</code></li>
            <li>Đăng nhập Admin: <code className="bg-gray-100 px-2 py-0.5 rounded">hoakhanhrunners@gmail.com / Admin@123</code></li>
            <li>Hoặc Member: <code className="bg-gray-100 px-2 py-0.5 rounded">member@gmail.com / Member@123</code></li>
          </ol>
        </div>
      </div>
    </div>
