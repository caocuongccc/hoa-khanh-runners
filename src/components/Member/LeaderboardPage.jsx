        ...
        <div className="flex items-end justify-center gap-4">
          ...
          {leaderboard[1] && (
            <div className="flex flex-col items-center">
              ...
              <p className="text-2xl font-bold text-gray-400">{leaderboard[1].totalPoints}</p>
          ...
          {leaderboard[0] && (
            <div className="flex flex-col items-center">
              ...
              <p className="text-3xl font-bold text-yellow-500">{leaderboard[0].totalPoints}</p>
          ...
          {leaderboard[2] && (
            <div className="flex flex-col items-center">
              ...
              <p className="text-2xl font-bold text-orange-600">{leaderboard[2].totalPoints}</p>
          ...
          <tbody className="divide-y divide-gray-200">
            {leaderboard.map((item) => (
              <tr key={item.userId} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 font-bold">{item.totalDistance.toFixed(1)} km</td>
                <td className="px-6 py-4">{item.validActivities}/{item.totalActivities}</td>
                <td className="px-6 py-4 font-bold text-blue-600">{item.totalPoints}</td>
              </tr>
            ))}
          </tbody>
        </table>
